...
// Original Bars, Heath Bars, Krunch Bars, Reese's Bars, Dark Chocolate Bars, Chocolate/Chocolate Bars,
// SAB NSA Krunch Bars, SAB RF NSA Vanilla Bars, then remaining
const skus = [
  {
    product_name: 'Klondike Original Bars',
  ...
  {
    product_name: 'Klondike Heath Bars',
  ...
  {
    product_name: "Klondike Reese's Bars",
  ...
  {
    product_name: 'Klondike Dark Chocolate Bars',
  ...
  {
    product_name: 'Klondike Chocolate/Chocolate Bars',
  ...
  {
    product_name: "Klondike Reese's Peanut Butter Cup Bars",
  ...
  {
    product_name: 'Klondike Original MTB Bars',
  ...
  {
    product_name: 'Klondike Mint Choc. Chip Bars 12-6PK',
  ...
  {
    product_name: 'Klondike Cookies and Creme Bars 12-6PK',
...
const seed = async () => {
  ...
  try {
    ...
    await client.query(
      `UPDATE skus SET active = false WHERE product_code = '69549032'`
    );
    ...
    for (const sku of skus) {
      await client.query(
        `INSERT INTO skus (
          product_name, product_code, cr_code, startup_cup_weight_target, sort_order,
        ...
        ON CONFLICT (product_code) DO UPDATE SET
          product_name=$1, cr_code=$3, startup_cup_weight_target=$4, sort_order=$5,
          thickness_label=$6, thickness_target=$7, thickness_lcl=$8, thickness_lwl=$9, thickness_uwl=$10, thickness_ucl=$11,
          weight_label=$12, weight_target=$13, weight_lcl=$14, weight_lwl=$15, weight_uwl=$16, weight_ucl=$17,
          coating_label=$18, coating_target=$19, coating_lcl=$20, coating_lwl=$21, coating_uwl=$22, coating_ucl=$23`,
        [
          sku.product_name, sku.product_code, sku.cr_code, sku.startup_cup_weight_target, sku.sort_order,
