...
router.post('/', async (req, res) => {
  ...
  try {
    const { line_id, sku_id, shift, shift_date, operator_name, supervisor_name, notes, best_buy_code } = req.body;
    ...
    const result = await client.query(
      `INSERT INTO shift_reports (
        ...
        total_measurements, best_buy_code,
      ...
      [
        ...
        measurements.length, best_buy_code || null,
